...
export default function Ds() {
  ...
  return (
    ...
    <div className='w-full flex justify-center items-center h-screen bg-whi'>
      ...
      <button onClick={downloadCSV} className=' text-2xl rounded-md flex gap-4 justify-center items-center font-bold sm:font-semibold font-mono px-5 py-3 bg-orange-600'>
